...
'''
Run a simple gallery to view the MNIST dataset and see the model's prediction.
Takes a little bit of time to load the model and the images.
'''
...
class MNISTGallery:
    def __init__(self, root, train_images):
        ...
        # Load the model weights from a numpy file
        self.load_model("sample-weights.npz")
    ...
    def predict_digit(self, image):
        ...
        # Forward pass using the loaded model for a single hidden layer
